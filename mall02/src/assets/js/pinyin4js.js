 ...
 */
  ...
  *暴露方法
  */
	import {cht2chsLibs} from "./libs/cht2chs";
	import assertEquals from "./libs/jsunit";
	import {PinyinsLib} from "./libs/pinyins";
	import {polyphonesLib} from "./libs/polyphones";
	window.pinyins = PinyinsLib;
	window.cht2chs = cht2chsLibs;
	window.polyphones = polyphonesLib;


export default function pinyin(words, toneType, upper, cap, split) {
